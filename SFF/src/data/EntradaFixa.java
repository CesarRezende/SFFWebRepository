...
/**
 * Entity implementation class for Entity: EntradasFixas
 *
 */
@Entity
@Audited
@Table(name="entrada_fixa")
public class EntradaFixa  extends GenericEntity implements Serializable {
	...
	@OneToMany(mappedBy="entradaFixa", cascade=CascadeType.ALL ,orphanRemoval=true)
